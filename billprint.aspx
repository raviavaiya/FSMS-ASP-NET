<%@ Page Title="Genrate Bill" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="billprint.aspx.cs" Inherits="billprint" %>
...
<asp:Button runat="server" ID="btnprint" Text="Download Invoice" CssClass="btn btn-success" OnClick="btnprint_Click" /></div>
</asp:Content>
