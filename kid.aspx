<%@ Page Title="Kid" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="kid.aspx.cs" Inherits="kid" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <main>
        ...
        <div class="container text-center">
            ...
            <h2><span style="color: #ff0000; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif">K</span>id's Collection</h2>
            <br>
            <div class="row">
